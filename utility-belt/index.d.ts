...
// type ButtonProps = PropsWithRequiredChildren<{ variant: "primary" | "danger" }>;
...
const Button = ({ variant }: { vairant: "primary" | "secondary" }) => null;

// Useful when you deal with component that does not give you its prop types
